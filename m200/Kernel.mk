...
cp $(KERNEL_OUT)/../hardware/amlogic/instaboot-prebuilt/instaboot.ko $(PRODUCT_OUT)/root/boot/
...
$(INTERMEDIATES_KERNEL): $(KERNEL_OUT) $(KERNEL_CONFIG)
	...
	$(MAKE) -C $(KERNEL_ROOTDIR) O=../$(KERNEL_OUT) M=../hardware/amlogic/instaboot-prebuilt ARCH=arm CROSS_COMPILE=$(PREFIX_CROSS_COMPILE) CONFIG_INSTABOOT_SUPPORT=m modules
