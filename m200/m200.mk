...
$(call inherit-product, device/amlogic/m200/device.mk)
...
PRODUCT_COPY_FILES += \
    device/amlogic/m200/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/m200/fstab.amlogic:root/fstab.amlogic
endif
#########################################################################
#
#                                                WiFi
