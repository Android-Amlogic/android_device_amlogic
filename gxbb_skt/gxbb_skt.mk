...
$(call inherit-product, device/amlogic/gxbb_skt/device.mk)
...
PRODUCT_NAME := gxbb_skt
PRODUCT_DEVICE := gxbb_skt
PRODUCT_BRAND := Android
PRODUCT_MODEL := AOSP on gxbb_skt
...
PRODUCT_COPY_FILES += \
    device/amlogic/gxbb_skt/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/gxbb_skt/fstab.amlogic:root/fstab.amlogic
endif
#########################################################################
#
#                                                WiFi
