...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := m200_iptv
...
ifeq ($(CHINA_MOBILE_ENABLE), true)
 TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/m200_iptv/res_pack_chinaMobile
else
 TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/m200_iptv/res_pack
endif

#TARGET_AMLOGIC_AML_LOGO := device/amlogic/m200_iptv/aml_logo.bmp
# Check Logo Size
