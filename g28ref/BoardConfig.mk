...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := g28ref
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/g28ref/res_pack
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/g28ref/aml_logo.bmp
# Check Logo Size
