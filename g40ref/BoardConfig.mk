...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := g40ref
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/g40ref/res_pack
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/g40ref/aml_logo.bmp
# Check Logo Size
