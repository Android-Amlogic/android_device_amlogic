...
KERNEL_DEVICETREE := gxbb_p200_2G
...
#	cp $(KERNEL_OUT)/../hardware/amlogic/pmu/aml_pmu_dev.ko $(TARGET_OUT)/lib/
	...
	-cp device/amlogic/$(TARGET_PRODUCT)/instaboot.ko $(PRODUCT_OUT)/root/boot/
#	cp $(KERNEL_OUT)/../hardware/amlogic/nand/amlnf/aml_nftl_dev.ko $(PRODUCT_OUT)/root/boot/
	cp $(shell pwd)/hardware/amlogic/nand/module/aml_nftl_dev.ko $(PRODUCT_OUT)/root/boot/
endef
...
#	$(MAKE) -C $(shell pwd)/$(PRODUCT_OUT)/obj/KERNEL_OBJ M=$(shell pwd)/hardware/amlogic/thermal/ ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(PREFIX_CROSS_COMPILE) modules
	$(MAKE) -C $(shell pwd)/$(PRODUCT_OUT)/obj/KERNEL_OBJ M=$(shell pwd)/hardware/amlogic/nand/amlnf_3.14 ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(PREFIX_CROSS_COMPILE) modules
	cp $(shell pwd)/hardware/amlogic/nand/amlnf_3.14/aml_nftl_dev.ko $(shell pwd)/hardware/amlogic/nand/module/aml_nftl_dev.ko
