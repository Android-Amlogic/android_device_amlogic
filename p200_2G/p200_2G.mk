...
$(call inherit-product, device/amlogic/p200_2G/device.mk)
...
PRODUCT_NAME := p200_2G
PRODUCT_DEVICE := p200_2G
PRODUCT_BRAND := Android
PRODUCT_MODEL := AOSP on p200_2G
...
PRODUCT_COPY_FILES += \
    device/amlogic/p200_2G/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/p200_2G/fstab.amlogic:root/fstab.amlogic
