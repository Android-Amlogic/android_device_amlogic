...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := m8bpxp
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/m8bpxp/res_pack
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/m8bpxp/aml_logo.bmp
# Check Logo Size
