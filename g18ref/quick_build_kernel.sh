...
function usage () {
	...
	echo "   device/amlogic/g18ref/quick_build_kernel.sh bootimage [kernel config]     --> build uImage"
	echo "   device/amlogic/g18ref/quick_build_kernel.sh recoveryimage [kernel config]  --> build recovery uImage"
	echo "   device/amlogic/g18ref/quick_build_kernel.sh usbburnimage                  --> uImage_usb_burning"
	echo "   device/amlogic/g18ref/quick_build_kernel.sh menuconfig                    --> open kernel menuconfig"
	echo "   device/amlogic/g18ref/quick_build_kernel.sh saveconfig                    --> savedefconfig"
}
...
KERNEL_USBBURN_CONFIG=meson6_g18_usb_burning_defconfig
