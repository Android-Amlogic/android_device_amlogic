...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := m8m2skt
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/m8m2skt/res_pack
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/m8m2skt/aml_logo.bmp
# Check Logo Size
