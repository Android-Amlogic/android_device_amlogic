...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := g20ref
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/g20ref/res_pack
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/g20ref/aml_logo.bmp
# Check Logo Size
