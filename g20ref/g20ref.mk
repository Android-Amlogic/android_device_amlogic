...
PRODUCT_DEVICE := g20ref
PRODUCT_MODEL := MBX reference board (g20ref)
...
# hdmi in
PRODUCT_PACKAGES += 	HdmiINOverlay
#       libaml_hdmi_in_hdmi_in_api \
#       hdmi_input 
...
$(call inherit-product-if-exists, vendor/amlogic/g20ref/device-vendor.mk)
