...
$(call inherit-product, device/amlogic/m201/device.mk)
...
PRODUCT_COPY_FILES += \
    device/amlogic/m201/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/m201/fstab.amlogic:root/fstab.amlogic
endif
#########################################################################
#
#                                                WiFi
