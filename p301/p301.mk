...
$(call inherit-product, device/amlogic/p301/device.mk)
...
PRODUCT_COPY_FILES += \
    device/amlogic/p301/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/p301/fstab.amlogic:root/fstab.amlogic
endif
#########################################################################
#
#                                                WiFi
