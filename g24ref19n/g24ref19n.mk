...
PRODUCT_NAME := g24ref19n
PRODUCT_MANUFACTURER := ZDMID
PRODUCT_DEVICE := g24ref19n
PRODUCT_MODEL := 19N-MX
...
#@C add for watchdog
PRODUCT_COPY_FILES += \
	device/amlogic/g24ref19n/libwatchdogjni.so:system/lib/libwatchdogjni.so


# inherit from the non-open-source side, if present
$(call inherit-product-if-exists, vendor/amlogic/g24ref19n/device-vendor.mk)
