...
PRODUCT_NAME := g18refmmcspi
PRODUCT_MANUFACTURER := MBX
PRODUCT_DEVICE := g18refmmcspi
PRODUCT_MODEL := MBX reference board (g18refmmcspi)
...
$(call inherit-product-if-exists, vendor/amlogic/g18refmmcspi/device-vendor.mk)
