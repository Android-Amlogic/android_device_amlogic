...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := g18refmmcspi
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/g18refmmcspi/res_pack
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/g18refmmcspi/aml_logo.bmp
# Check Logo Size
