...
$(call inherit-product, device/amlogic/gxtvbb_skt/device.mk)
...
PRODUCT_NAME := gxtvbb_skt
PRODUCT_DEVICE := gxtvbb_skt
PRODUCT_BRAND := Android
PRODUCT_MODEL := AOSP on gxtvbb_skt
...
PRODUCT_COPY_FILES += \
    device/amlogic/gxtvbb_skt/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/gxtvbb_skt/fstab.amlogic:root/fstab.amlogic
endif
#########################################################################
#
#                                                WiFi
