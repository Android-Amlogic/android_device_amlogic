...
PRODUCT_NAME := adas_s812
PRODUCT_MANUFACTURER := MBX
PRODUCT_DEVICE := adas_s812
PRODUCT_MODEL := adas_s812
...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/ueventd.amlogic.rc:root/ueventd.amlogic.rc

PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/init.amlogic.board.rc:root/init.amlogic.board.rc

PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/adas_init.sh:system/bin/adas_init.sh \
	$(LOCAL_PATH)/adas_config.sh:system/bin/adas_config.sh

PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/gm7150.sh:system/bin/gm7150.sh \
	$(LOCAL_PATH)/show_cvbsin.sh:system/bin/show_cvbsin.sh
...
$(call inherit-product-if-exists, vendor/amlogic/adas_s812/device-vendor.mk)
