...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := k100
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/k100/res_pack
TARGET_BUILD_WIPE_USERDATA := false
TARGET_USERIMAGES_USE_EXT4 := true
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 1073741824
BOARD_FLASH_BLOCK_SIZE := 2048
TARGET_RECOVERY_HIGH_DENSITY := xxhdpi
TARGET_RECOVERY_ROBOTO_15X24 := true
