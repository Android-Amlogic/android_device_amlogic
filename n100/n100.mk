...
#  PRODUCT_COPY_FILES += \
#	$(LOCAL_PATH)/n100_2G/init.amlogic.board.rc:root/init.amlogic.board.rc 
#else
  PRODUCT_COPY_FILES += \
...
$(call inherit-product-if-exists, vendor/amlogic/n100/device-vendor.mk)
