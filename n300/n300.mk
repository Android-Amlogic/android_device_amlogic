...
$(call inherit-product, device/amlogic/n300/device.mk)
...
#########################################################################
#
#                        SecureBoot and Dm-verity With Tool
#
#########################################################################
# true is for secureboot and dm-verity mode with pc encrypt tool.
# default false.
...
PRODUCT_COPY_FILES += \
    device/amlogic/n300/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/n300/fstab.amlogic:root/fstab.amlogic
endif
#########################################################################
#
#                                                WiFi
...
#TV TUNER MODULES
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/si2151_fe.ko:/root/boot/si2151_fe.ko \
