...
case $1 in 
    ...
    panel)
        fbset -fb /dev/graphics/fb0 -g 768 1024 768 3072 32
        echo 1 > /sys/class/graphics/fb1/blank
        fbset -fb /dev/graphics/fb1 -g 1024 768 1024 2304 32
        echo $1 > /sys/class/display/mode
        echo 0 0 768 1024 0 0 1024 768 > /sys/class/display/axis
    ;;
    
    mode_set_before)
        fbset -fb /dev/graphics/fb0 -g 768 1024 768 3072 32
        #fbset -fb /dev/graphics/fb1 -g 32 32 32 32 32
        echo 0 0 768 1024 0 0 32 32 > /sys/class/display/axis
    ;;
