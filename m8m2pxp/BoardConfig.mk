...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := m8m2pxp
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/m8m2pxp/res_pack
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/m8m2pxp/aml_logo.bmp
# Check Logo Size
