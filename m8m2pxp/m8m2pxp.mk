...
PRODUCT_NAME := m8m2pxp
PRODUCT_MANUFACTURER := MBX
PRODUCT_DEVICE := m8m2pxp
PRODUCT_MODEL := MBX socket board (m8m2pxp)
...
$(call inherit-product-if-exists, vendor/amlogic/m8m2pxp/device-vendor.mk)
