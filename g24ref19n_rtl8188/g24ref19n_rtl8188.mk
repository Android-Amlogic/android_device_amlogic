...
PRODUCT_NAME := g24ref19n_rtl8188
PRODUCT_MANUFACTURER := ZDMID
PRODUCT_DEVICE := g24ref19n_rtl8188
PRODUCT_MODEL := 19N-R
...
#@C add for zhuyin input

# PRODUCT_COPY_FILES += $(LOCAL_PATH)/Zhuyinshurufa.apk:system/app/Zhuyinshurufa.apk 

#@C add for watchdog
PRODUCT_COPY_FILES += \
	device/amlogic/g24ref19n_rtl8188/libwatchdogjni.so:system/lib/libwatchdogjni.so

#@add by Lorin for sleep-wakeup backlight
 PRODUCT_COPY_FILES += $(LOCAL_PATH)/libgpiojni.so:system/lib/libgpiojni.so

# inherit from the non-open-source side, if present
$(call inherit-product-if-exists, vendor/amlogic/g24ref19n_rtl8188/device-vendor.mk)
