...
PRODUCT_NAME := g33ref1212New
PRODUCT_MANUFACTURER := MID
PRODUCT_DEVICE := g33ref1212New
...
PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/gsensor.cfg:system/etc/gsensor.cfg

# inherit from the non-open-source side, if present
$(call inherit-product-if-exists, vendor/amlogic/g33ref1212New/device-vendor.mk)
