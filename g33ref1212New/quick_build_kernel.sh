...
function usage () {
	...
	echo "   device/amlogic/g33ref1212New/quick_build_kernel.sh bootimage [kernel config]     --> build boot.img"
	echo "   device/amlogic/g33ref1212New/quick_build_kernel.sh recoveryimage [kernel config]  --> recovery.img"
	echo "   device/amlogic/g33ref1212New/quick_build_kernel.sh usbbrunimage                  --> uImage_usb_burning"
	echo "   device/amlogic/g33ref1212New/quick_build_kernel.sh menuconfig                    --> open kernel menuconfig"
	echo "   device/amlogic/g33ref1212New/quick_build_kernel.sh saveconfig                    --> make defconfig &  make savedefconfig"
}
...
#{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{
KERNEL_DEFCONFIG=meson6_g33_1212New_jb_defconfig
KERNEL_USBBURN_CONFIG=meson6_g33_1212New_jb_burning_defconfig
KERNET_ROOTDIR=common
PROJECT_NAME=g33ref1212New
#}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}
