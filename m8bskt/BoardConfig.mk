...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := m8bskt
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/m8bskt/res_pack
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/m8bskt/aml_logo.bmp
# Check Logo Size
