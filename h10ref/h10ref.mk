...
PRODUCT_DEVICE := h10ref
PRODUCT_MODEL := TV DVBC/ATSC reference board (h10ref)
...
PRODUCT_COPY_FILES += $(LOCAL_PATH)/8192du.ko:system/lib/8192du.ko
PRODUCT_COPY_FILES += $(LOCAL_PATH)/8712u.ko:system/lib/8712u.ko
PRODUCT_COPY_FILES += $(LOCAL_PATH)/8188eu.ko:system/lib/8188eu.ko
PRODUCT_COPY_FILES += $(LOCAL_PATH)/rt5370sta.ko:system/lib/rt5370sta.ko
PRODUCT_COPY_FILES += $(LOCAL_PATH)/cfg80211.ko:system/lib/cfg80211.ko
PRODUCT_COPY_FILES += $(LOCAL_PATH)/compat.ko:system/lib/compat.ko
PRODUCT_COPY_FILES += $(LOCAL_PATH)/cfg80211_ath6kl.ko:system/lib/cfg80211_ath6kl.ko
PRODUCT_COPY_FILES += $(LOCAL_PATH)/ath6kl_usb.ko:system/lib/ath6kl_usb.ko
...
PRODUCT_COPY_FILES += $(LOCAL_PATH)/tv_setting_config.cfg:system/etc/tv_setting_config.cfg
