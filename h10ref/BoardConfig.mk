...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := h10ref
...
# TV
BOARD_HAVE_TV := true
BOARD_TVAPI_HAVE_TVPLAYER := true

#fast booting of special function for tv
TV_FASTBOOTING_FUNCTION :=true

TARGET_AMLOGIC_PARAM := device/amlogic/h10ref/param
INSTALLED_AML_LOGO := device/amlogic/h10ref/logo.bmp
TARGET_CP_H10REF_ROOT_FILES := true
