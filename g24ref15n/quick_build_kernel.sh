...
function usage () {
	...
	echo "   device/amlogic/g24ref15n/quick_build_kernel.sh bootimage [kernel config]     --> build boot.img"
	echo "   device/amlogic/g24ref15n/quick_build_kernel.sh recoveryimage [kernel config]  --> recovery.img"
	echo "   device/amlogic/g24ref15n/quick_build_kernel.sh usbburingimage                  --> usb_burning.img"
	echo "   device/amlogic/g24ref15n/quick_build_kernel.sh menuconfig                    --> open kernel menuconfig"
	echo "   device/amlogic/g24ref15n/quick_build_kernel.sh saveconfig                    --> make defconfig &  make savedefconfig"
}
