...
PRODUCT_NAME := g24ref15n
PRODUCT_MANUFACTURER := ZDMID
PRODUCT_DEVICE := g24ref15n
...
#@C add for watchdog
PRODUCT_COPY_FILES += \
	device/amlogic/g24ref15n/libwatchdogjni.so:system/lib/libwatchdogjni.so
...
$(call inherit-product-if-exists, vendor/amlogic/g24ref15n/device-vendor.mk)
