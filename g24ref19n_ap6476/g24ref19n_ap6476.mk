...
PRODUCT_NAME := g24ref19n_ap6476
PRODUCT_MANUFACTURER := ZDMID
PRODUCT_DEVICE := g24ref19n_ap6476
PRODUCT_MODEL := 19N-A
...
# G-Sensor # @S Add memsic mxc622x g-sensor support. 20130821
#BOARD_USES_G_SENSOR_MEMSIC := false
#BOARD_USES_G_SENSOR_MEMSIC_MXC622X_MMC314X := false
...
#@C add for watchdog
PRODUCT_COPY_FILES += \
	device/amlogic/g24ref19n_ap6476/libwatchdogjni.so:system/lib/libwatchdogjni.so


# inherit from the non-open-source side, if present
$(call inherit-product-if-exists, vendor/amlogic/g24ref19n_ap6476/device-vendor.mk)
