...
$(call inherit-product, device/amlogic/n210/device.mk)
...
PRODUCT_COPY_FILES += \
    device/amlogic/n210/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/n210/fstab.amlogic:root/fstab.amlogic
endif
#########################################################################
#
#                                                WiFi
