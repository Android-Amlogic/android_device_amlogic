...
function usage () {
	...
	echo "   device/amlogic/g24ref15n_r/quick_build_kernel.sh bootimage [kernel config]     --> build boot.img"
	echo "   device/amlogic/g24ref15n_r/quick_build_kernel.sh recoveryimage [kernel config]  --> recovery.img"
	echo "   device/amlogic/g24ref15n_r/quick_build_kernel.sh usbburingimage                  --> usb_burning.img"
	echo "   device/amlogic/g24ref15n_r/quick_build_kernel.sh menuconfig                    --> open kernel menuconfig"
	echo "   device/amlogic/g24ref15n_r/quick_build_kernel.sh saveconfig                    --> make defconfig &  make savedefconfig"
}
...
#{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{
KERNEL_DEFCONFIG=meson6_g24_jbmr1_15n_r_defconfig
KERNEL_USB_BURNING_DEFCONFIG=meson6_g24_15n_r_usb_burning_defconfig
KERNET_ROOTDIR=common
PROJECT_NAME=g24ref15n_r
#}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}
...
echo "Build $PRODUCT_OUT/usb_burning.img Done"
exit 0
fi
############################## menuconfig ####################################
