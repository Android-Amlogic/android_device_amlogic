...
$(call inherit-product, device/amlogic/n200C/device.mk)
...
PRODUCT_COPY_FILES += \
    device/amlogic/n200C/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/amlogic/n200C/fstab.amlogic:root/fstab.amlogic
endif
#########################################################################
#
#                                                WiFi
