...
PRODUCT_NAME := g24ref19n_prodvx
PRODUCT_MANUFACTURER := ZDMID
PRODUCT_DEVICE := g24ref19n_prodvx
PRODUCT_MODEL := FMT-19AT
...
#@C add for watchdog
PRODUCT_COPY_FILES += \
	device/amlogic/g24ref19n_prodvx/libwatchdogjni.so:system/lib/libwatchdogjni.so


# inherit from the non-open-source side, if present
$(call inherit-product-if-exists, vendor/amlogic/g24ref19n_prodvx/device-vendor.mk)
