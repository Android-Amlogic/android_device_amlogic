...
function usage () {
	...
	echo "   device/amlogic/g02refDongle/quick_build_kernel.sh bootimage [kernel config]     --> build uImage"
	echo "   device/amlogic/g02refDongle/quick_build_kernel.sh recoveryimage [kernel config]  --> build recovery uImage"
	echo "   device/amlogic/g02refDongle/quick_build_kernel.sh usbburnimage                  --> uImage_usb_burning"
	echo "   device/amlogic/g02refDongle/quick_build_kernel.sh menuconfig                    --> open kernel menuconfig"
	echo "   device/amlogic/g02refDongle/quick_build_kernel.sh saveconfig                    --> savedefconfig"
}
...
#{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{
KERNEL_DEFCONFIG=meson6_g02_dongle_defconfig
KERNEL_USBBURN_CONFIG=meson6_g02_dongle_usb_burning_defconfig
KERNET_ROOTDIR=common
PROJECT_NAME=g02refDongle
#}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}
