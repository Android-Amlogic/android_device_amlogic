...
PRODUCT_NAME := g02refDongle
PRODUCT_MANUFACTURER := MBX
PRODUCT_DEVICE := g02refDongle
PRODUCT_MODEL := MBX Dongle board (g02refDongle)
...
$(call inherit-product-if-exists, vendor/amlogic/g02refDongle/device-vendor.mk)
