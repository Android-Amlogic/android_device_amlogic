...
##################################################### release package
TARGET_BOOTLOADER_BOARD_NAME := g02refDongle
...
TARGET_AMLOGIC_RES_PACKAGE := device/amlogic/g02refDongle/res_pack
#TARGET_AMLOGIC_AML_LOGO := device/amlogic/g02refDongle/aml_logo.bmp
# Check Logo Size
