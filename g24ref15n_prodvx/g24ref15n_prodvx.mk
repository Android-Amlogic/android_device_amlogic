...
PRODUCT_NAME := g24ref15n_prodvx
PRODUCT_MANUFACTURER := ZDMID
PRODUCT_DEVICE := g24ref15n_prodvx
PRODUCT_MODEL := 15-APPC-DS
...
#@C add for watchdog
PRODUCT_COPY_FILES += \
	device/amlogic/g24ref15n_prodvx/libwatchdogjni.so:system/lib/libwatchdogjni.so


# inherit from the non-open-source side, if present
$(call inherit-product-if-exists, vendor/amlogic/g24ref15n_prodvx/device-vendor.mk)
